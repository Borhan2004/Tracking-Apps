            ...
            return GridView.count(
              ...
              children: [
                StatCard(
                  ...
                  progress: controller.parcent(caloriesPerDay), starValue: caloriesPerDay,
                ),
                StatCard(
                  title: 'Total Calories',
                  value: '$totalCalories kcal',
                  image: 'assets/images/reduce.png',
                  progress: controller.parcent(totalCalories.toDouble()), starValue: totalCalories.toDouble(),
                ),
                StatCard(
                  title: 'Football Fields',
                  value: '${footballFields.toInt()} times',
                  image: 'assets/images/football.png',
                  progress: controller.parcent(footballFields), starValue: footballFields,
                ),
                StatCard(
                  title: 'Marathons',
                  value: '${marathons.toStringAsFixed(2)} times',
                  image: 'assets/images/marathon.png',
                  progress: controller.parcent(marathons), starValue: marathons,
                ),
                StatCard(
                  title: 'Earth Circuits',
                  value: '${earthCircuits.toStringAsFixed(4)} times',
                  image: 'assets/images/earth.png',
                  progress: controller.parcent(earthCircuits), starValue: earthCircuits,
                ),
                StatCard(
                  title: 'Eiffel Towers',
                  value: '${eiffelTowers.toStringAsFixed(2)} times',
                  image: 'assets/images/eiffelTower.png',
                  progress: controller.parcent(eiffelTowers), starValue: eiffelTowers,
                ),
                StatCard(
                  title: 'Burj Khalifa',
                  value: '${burjKhalifas.toStringAsFixed(2)} times',
                  image: 'assets/images/burjKhalifa.png',
                  progress: controller.parcent(burjKhalifas), starValue: burjKhalifas,
                ),
                StatCard(
                  title: 'Space Station',
                  value: '${spaceStations.toStringAsFixed(4)} times',
                  image: 'assets/images/satellite.png',
                  progress: controller.parcent(spaceStations), starValue: spaceStations,
                ),
              ],
            );
          }),
